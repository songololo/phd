...
for d in [200, 400, 800, 1600]:
    ...
    df_data_dual[f'ang_closeness_{d}_1'] = df_data_dual[f'ang_node_count_{d}'] ** 2 / (df_data_dual[f'ang_farness_{d}'] + df_data_dual[f'ang_node_count_{d}'])
    df_data_dual[f'ang_closeness_{d}_10'] = df_data_dual[f'ang_node_count_{d}']**2 / (df_data_dual[f'ang_farness_{d}'] + df_data_dual[f'ang_node_count_{d}'] * 10)
