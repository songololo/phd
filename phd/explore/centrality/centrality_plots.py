...
all_distances = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 3200, 4800, 6400, 8000]
...
for n, (theme_set, theme_labels, theme_meta, theme_wt) in enumerate(zip(theme_sets, theme_label_sets, theme_metas, theme_wts)):
...
plt.suptitle('Comparative distributions and scatterplots for network centrality measures compared to mixed-use richness')
...
for angular in [False, True]:
    ...
    if angular:
        plt.suptitle(r'Correlations for angular network centrality measures to length normalised mixed-uses at varying decompositions')
        path = f'../phd-admin/PhD/part_2/images/centrality/primal_decompositions_angular.png'
    else:
        plt.suptitle(r'Correlations for network centrality measures to length-normalised mixed-uses at varying decompositions')
