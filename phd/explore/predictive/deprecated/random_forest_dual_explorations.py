...
for d in distances:
    df_data_dual_full_clean[f'comp_imp_met_far_{d}'] = df_data_dual_full_clean[f'comp_met_farness_{d}'] / df_data_dual_full_clean[f'comp_node_count_{d}'] ** 2
    df_data_dual_100_clean[f'comp_imp_met_far_{d}'] = df_data_dual_100_clean[f'comp_met_farness_{d}'] / df_data_dual_100_clean[f'comp_node_count_{d}'] ** 2
    df_data_dual_50_clean[f'comp_imp_met_far_{d}'] = df_data_dual_50_clean[f'comp_met_farness_{d}'] / df_data_dual_50_clean[f'comp_node_count_{d}'] ** 2
    df_data_dual_20_clean[f'comp_imp_met_far_{d}'] = df_data_dual_20_clean[f'comp_met_farness_{d}'] / df_data_dual_20_clean[f'comp_node_count_{d}'] ** 2

    df_data_dual_full_clean[f'comp_imp_ang_far_{d}'] = df_data_dual_full_clean[f'comp_ang_farness_{d}'] / df_data_dual_full_clean[f'comp_node_count_{d}'] ** 2
    df_data_dual_100_clean[f'comp_imp_ang_far_{d}'] = df_data_dual_100_clean[f'comp_ang_farness_{d}'] / df_data_dual_100_clean[f'comp_node_count_{d}'] ** 2
    df_data_dual_50_clean[f'comp_imp_ang_far_{d}'] = df_data_dual_50_clean[f'comp_ang_farness_{d}'] / df_data_dual_50_clean[f'comp_node_count_{d}'] ** 2
    df_data_dual_20_clean[f'comp_imp_ang_far_{d}'] = df_data_dual_20_clean[f'comp_ang_farness_{d}'] / df_data_dual_20_clean[f'comp_node_count_{d}'] ** 2
...
# mod = svm.SVR()  # -14.74%
from sklearn.gaussian_process import GaussianProcessRegressor  # SIGKILL
