...
df_data_cent_full = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_full', 'WHERE city_pop_id = 1'))
df_data_cent_full = df_data_cent_full.set_index('id')
df_data_landuse_full = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_full_lu', 'WHERE city_pop_id = 1'))
...
df_data_cent_100 = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_100', 'WHERE city_pop_id = 1'))
df_data_cent_100 = df_data_cent_100.set_index('id')
df_data_landuse_100 = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_100_lu', 'WHERE city_pop_id = 1'))
...
df_data_cent_50 = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_50', 'WHERE city_pop_id = 1'))
df_data_cent_50 = df_data_cent_50.set_index('id')
df_data_landuse_50 = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_50_lu', 'WHERE city_pop_id = 1'))
...
df_data_cent_20 = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_20', 'WHERE city_pop_id = 1'))
df_data_cent_20 = df_data_cent_20.set_index('id')
df_data_landuse_20 = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_20_lu', 'WHERE city_pop_id = 1'))
