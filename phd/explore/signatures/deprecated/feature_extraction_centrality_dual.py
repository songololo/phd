...
from sklearn.preprocessing import power_transform, robust_scale, minmax_scale
...
df_data_cent_full_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_full_dual', 'WHERE city_pop_id = 1'))
...
df_data_landuse_full_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_full_dual', 'WHERE city_pop_id = 1'))
...
df_data_cent_100_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_100_dual', 'WHERE city_pop_id = 1'))
df_data_cent_100_dual = df_data_cent_100_dual.set_index('id')
# TODO: accidentally wrote the landuse columns to normal database - update if ever running again
df_data_landuse_100_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_100_dual', 'WHERE city_pop_id = 1'))
...
df_data_cent_50_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_50_dual', 'WHERE city_pop_id = 1'))
df_data_cent_50_dual = df_data_cent_50_dual.set_index('id')
# TODO: accidentally wrote the landuse columns to normal database - update if ever running again
df_data_landuse_50_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_50_dual', 'WHERE city_pop_id = 1'))
...
df_data_cent_20_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, centrality_columns, 'analysis.roadnodes_20_dual', 'WHERE city_pop_id = 1'))
df_data_cent_20_dual = df_data_cent_20_dual.set_index('id')
# TODO: accidentally wrote the landuse columns to normal database - update if ever running again
df_data_landuse_20_dual = asyncio.run(phd_util.load_data_as_pd_df(db_config, landuse_columns, 'analysis.roadnodes_20_dual', 'WHERE city_pop_id = 1'))
