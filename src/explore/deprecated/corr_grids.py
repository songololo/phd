...
for d in [200, 400, 800, 1600]:
    corr_data_ldn_100[f'area_cov_wt_{d}'] = np.sqrt(corr_data_ldn_100[f'area_variance_wt_{d}']) / corr_data_ldn_100[
        f'area_mean_wt_{d}']
    corr_data_ldn_100[f'rate_cov_wt_{d}'] = np.sqrt(corr_data_ldn_100[f'rate_variance_wt_{d}']) / corr_data_ldn_100[
        f'rate_mean_wt_{d}']
...
for d in [200, 400, 800, 1600]:
    ...
    plt.title(f'{table_100}: spearman ' + r'$\rho$' + f' correlations at distance: {d}m', size='xx-small',
              fontweight='bold')
    plt.show()
...
for d in [200, 400, 800, 1600]:
    corr_data_ldn_20[f'area_cov_wt_{d}'] = np.sqrt(corr_data_ldn_20[f'area_variance_wt_{d}']) / corr_data_ldn_20[
        f'area_mean_wt_{d}']
    corr_data_ldn_20[f'rate_cov_wt_{d}'] = np.sqrt(corr_data_ldn_20[f'rate_variance_wt_{d}']) / corr_data_ldn_20[
        f'rate_mean_wt_{d}']
...
for d in [200, 400, 800, 1600]:
    ...
    plt.xticks(fontsize=fontsize, fontweight='bold', rotation=90)
    plt.yticks(fontsize=fontsize, fontweight='bold', rotation=0)
    plt.title(f'{table_20}: spearman ' + r'$\rho$' + f' correlations at distance: {d}m', size='xx-small',
              fontweight='bold')
    plt.show()
