...
for x, y, town_name in [(485970, 236920, 'Milton Keynes'),
    ...
    path = f'../phd-doc/doc/part_3/images/predicted/nt_hyperlocal_pred_{town_name}_{m2.theme}_{clf.theme}.pdf'
...
path = f'../phd-doc/doc/part_3/images/predicted/nt_dists_probs_{m2.theme}_{clf.theme}.pdf'
plt.savefig(path, dpi=300)
