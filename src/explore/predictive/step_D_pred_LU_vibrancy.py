...
path = f'../phd-doc/doc/part_3/images/predicted/eatery_predictions_400_{reg.theme}.pdf'
...
path = f'../phd-doc/doc/part_3/images/predicted/validation_curve_{reg.theme}.pdf'
plt.savefig(path, dpi=300)
