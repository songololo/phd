...
for x, y, town_name in [(485970, 236920, 'Milton Keynes'),
    ...
    path = f'../phd-doc/doc/part_3/images/predicted/stage_2_DNN_{town_name}_{clf.theme}_yc{y_conf}.pdf'
...
path = f'../phd-doc/doc/part_3/images/predicted/nt_dists_probs_{clf.theme}.pdf'
plt.savefig(path, dpi=300)
