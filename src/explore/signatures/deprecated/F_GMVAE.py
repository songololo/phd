...
from src.explore.signatures.deprecated import D_GMVAE_Model
...
plot_funcs.plot_prob_clusters(cluster_probs_gmVAE_closeup, f'{gmVAE_closeup.theme}_mu_closeup', table.x[idx],
                              table.y[idx])
#  %%
phd_util.plt_setup()
fig, ax = plt.subplots(1, 1, figsize=(12, 10))
