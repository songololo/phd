...
table_names = ['analysis.roadnodes_full_lu', 'analysis.roadnodes_100_lu', 'analysis.roadnodes_50_lu',
               'analysis.roadnodes_20_lu']
...
for table, table_name in zip(tables, table_names):
    ...
    phd_util.plt_setup()
    df_stepped.plot.scatter('mu_hill_branch_wt_0_100', 'mu_hill_branch_wt_0_1600',
                            c=set_colours(df_stepped.step_b_labels))
    plt.suptitle(theme)
    ...
    phd_util.plt_setup()
    df_stepped.plot.scatter('mu_hill_branch_wt_0_100', 'mu_hill_branch_wt_0_1600',
                            c=set_colours(df_stepped.step_c_labels))
    plt.suptitle(theme)
